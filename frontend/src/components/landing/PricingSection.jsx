      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Everything you need to transform your meal planning, all in one place.
          </p>
        </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="mb-6">
                  ...
                  <span className="text-2xl text-[#6B5344] ml-2">/month</span>
                </div>
              ...
              {/* Right: Embedded Testimonial */}
              <motion.div
                initial={{ opacity: 0, scale: 0.9 }}
                animate={inView ? { opacity: 1, scale: 1 } : {}}
                transition={{ delay: 0.5, duration: 0.6 }}
                className="relative bg-gradient-to-br from-cream-peachy to-cream p-8 lg:p-10 rounded-2xl border-2 border-orange-100"
              >
                {/* Quote Icon */}
                <div className="absolute top-6 right-6 text-orange-200 text-6xl font-serif leading-none">
                  "
                </div>

                {/* Testimonial Content */}
                <div className="relative">
                  <p className="text-lg lg:text-xl text-[#4A3728] font-medium mb-6 italic leading-relaxed">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-bold text-[#4A3728]">Sarah Johnson</div>
                      <div className="text-sm text-[#6B5344]">Home Cook, Mom of 3</div>
                    </div>
                  </div>
        ...
        >
          <p className="text-lg">
            ✓ 7-day money-back guarantee • ✓ 2,000+ happy cooks • ✓ Cancel anytime
          </p>
        </motion.div>
      </div>
    </section>
